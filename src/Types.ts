...
export interface NodeOptions {
    ...
    /** Maximum random variation applied to reconnect delays as a fraction. */ retryJitter?: number;
    /** Upper bound for exponential reconnect backoff in milliseconds. */ maxRetryInterval?: number;
}
